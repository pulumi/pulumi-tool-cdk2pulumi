...
## Goal
Develop a reusable conversion pipeline that takes an existing AWS CDK application, synthesizes it, converts the resulting CloudFormation templates into Pulumi resource definitions, and emits Pulumi YAML. This toolchain now lives in this standalone `pulumi-cdk-convert` repository.
