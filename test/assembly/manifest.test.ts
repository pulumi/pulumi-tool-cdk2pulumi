...
describe('cloud assembly manifest reader', () => {
  describe('single stack', () => {
    ...
    const manifestStack =
      '/tmp/foo/bar/does/not/exist/test-stack.template.json';
            ...
            abe4e2f4fcc1aaaf53db4829c23a5cf08795d36cce0f68a3321c1c8d728fec44: {
              ...
              destinations: {
                'current_account-current_region': {
                  ...
                  objectKey:
                    'abe4e2f4fcc1aaaf53db4829c23a5cf08795d36cce0f68a3321c1c8d728fec44.zip',
                },
              },
            },
              ...
              destinations: {
                'current_account-current_region': {
                  bucketName:
                    'cdk-hnb659fds-assets-${AWS::AccountId}-${AWS::Region}',
                  objectKey:
                    'cd12352cc95113284dfa6575f1d74d8dea52dddcaa2f46fa695b33b59c1b4579.json',
                },
              },
            },
          },
    ...
    test('fromPath sets directory correctly', () => {
      const manifest = AssemblyManifestReader.fromDirectory(
  ...
  describe('nested stacks', () => {
    ...
    test('throws if nested stack template is not found', () => {
      ...
      const manifestAssets =
        '/tmp/foo/bar/does/not/exist/test-stack.assets.json';
      mockfs({
        [manifestAssets]: JSON.stringify({
          version: '36.0.0',
          files: {
